...
urlpatterns = [
    ...
    path('admin/requests/<int:pk>/', AdminSubscriptionRequestDetailView.as_view(), name='admin-subscription-request-detail'), 
    path('admin/stats/', AdminSubscriptionStatsView.as_view(), name='admin-subscription-stats'),  # 👈 Add this
]